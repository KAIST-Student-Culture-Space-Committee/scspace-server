...
export class AuthController {
  ...
  @Public()
  @Get('callback')
  async ssoCallback( // first generate Tokens.
  ...
  return { ok: true };
      ...
      return res.status(HttpStatus.BAD_REQUEST).json({ message: 'Failed to accept privacy consent' });
    }
  }
  ...
  private async getUserInfoFromAccessToken(accessToken: string): Promise<IUser | null> {
    try {
